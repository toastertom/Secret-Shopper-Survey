angular.module('lozQuiz').controller('mainCtrl', function ($scope, $http, $sce) {
  ...
  $scope.createShareLinks = function (percentage) {
    ...
    var emailLink = '<a class="btn email" href="mailto:?subject= Secret Shoper Servey!&amp;body=Steadmans scored '+percentage+' percent on this secret shopper survey.">Submit</a>';
